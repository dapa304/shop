        ...
        <!--==================== MAIN ====================-->
            ...
            <div class="home" id="home">
                <div class="home__container container grid">
                    ...
                    <h1 class="home__title move-text parallax-two" id="home-txt">THE PROPERTY STORE <br> THAT SELLING SIMPLICITY.</h1>
            ...
            <div class="container-slide">
                <div class="wrapper section">
                    ...
                    <section class="story About">
                        <div class="block"></div>
                        <span class="huge-text">About</span>
                        <div class="caption">
                             Explore our curated selection of property, ranging from classic pumps and sneakers to funky boots and stylish sandals.    
                        </div>
                        <div class="quote">
                            Give you a branded property with Affordable price
                        </div>
                    </section>
                    
                    <section class="story Testimony ">
                        <div class="block"></div>
                       <span class="huge-text">Story</span>
                        <div class="caption">
                        ...
                        <div class="quote">
                            Get your favorite property right now!
                        </div>
                    </section>
                </div>
            ...
            <div class="story section container">
                <div class="story__container grid">
                    <div class="story__data">
                        ...
                        Please choose the type and design of property according to your needs and tastes, here, only at DAFT Store!
                        </p>
                    ...
                    <div class="story__images">
                        <img src="assets/img/lemari 1.jpg" alt="" class="story__img">
                    </div>
                </div>
            </div>
